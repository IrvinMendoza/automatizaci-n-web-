Feature: TI-EA2023-12608-R3 Compliance getExtenalLink
  ...
  Scenario Outline: <Peticion>
    ...
    ##@externaldata@src/test/resources/Datadriven/ModuloR4/ModuloR4UAT.xlsx@API2
|Prueba2|Prueba2|URL_BASE_REDIRECCIONAR_LINK1|/|GET||name:Irvin|200|message|Welcome to the Simple Books API.|||||
